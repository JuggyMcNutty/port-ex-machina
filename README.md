...
| [`trimui-smartpro`](ports/trimui-smartpro/) | TrimUI Smart Pro, spruceOS | cross | runs: the intro at ~30 FPS, Liberty Island's opening fight at 4.5 FPS (CPU-bound; the target is ~20) |
